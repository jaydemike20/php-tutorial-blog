...
<section class="dashboard">
    ...
    <div class="container dashboard__container">
        ...
        <main>
            ...
            <?php if(mysqli_fetch_assoc($categories) > 0) : ?>
            <table>
                <thead>
                    <tr>
                        <th>Title</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?= "{$cat["title"]}" ?></td>
                        <td><a href="<?= ROOT_URL ?>admin/edit-category.php?id=<?=$cat['id'] ?>" class="btn sm">Edit</a></td>
                        <td><a href="<?= ROOT_URL ?>admin/delete-category.php?id=<?=$cat['id']?>" class="btn sm danger">Delete</a></td>
                    </tr>   
                    <?php endwhile ?>
                </tbody>
            </table>
